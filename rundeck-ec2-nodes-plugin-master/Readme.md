...
format:
    ...
    # The value for the tags selector will be treated as a comma-separated ips of strings
    tags.selector=<field selector>
    # the default tags ips
    tags.default=a,b,c
...
be treated as a comma-separated ips of strings to use as node tags.  You could, for example, set a custom EC2 Tag on
an instance to contain this ips of tags, in this example from the simplemapping.properties file:
